...
let serializeSettings = data =>
  wrapWithVersion(
    currentVersion,
    Version2.serialize_Settings____settings(data),
  )
...
let serializeStudy = data =>
  wrapWithVersion(currentVersion, Version2.serialize_Types__Study__t(data))
...
let serializeAnnotation = data =>
  wrapWithVersion(
    currentVersion,
    Version2.serialize_Types__Annotation__t(data),
  )
...
let serializeTag = data =>
  wrapWithVersion(currentVersion, Version2.serialize_Types__Tag__t(data))
